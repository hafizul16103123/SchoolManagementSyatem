...
<body>
    <div id="app" class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle"  href="{{route('stu_notice')}}" role="button"  aria-haspopup="true" aria-expanded="false" v-pre>
        ...
        <nav class="navbar navbar-dark bg-success container " style="height: 70px">
            <p style="margin-left:45% ;margin-top: 25px">&copy Md. Hafizul Islam from IUBAT</p>
        </nav>
    </div>
    <!-- Optional JavaScript -->
