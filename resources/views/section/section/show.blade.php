            ...
            <div class="col-md-8">
                <div class="card bg-info">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ url('/section/' . $section->id . '/edit') }}" title="Edit Section"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
