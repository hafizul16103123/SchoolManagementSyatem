        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="card bg-info">
                    <div class="card-header">Admissionfeepay</div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                @foreach($admissionfeepay as $item)
                                    <tr>
                            ...
                            <div class="pagination-wrapper"> {!! $admissionfeepay->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
