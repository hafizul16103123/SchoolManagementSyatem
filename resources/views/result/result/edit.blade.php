            ...
            <div class="col-md-8">
                <div class="card bg-info">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('/result/' . $result->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ method_field('PATCH') }}
                            {{ csrf_field() }}

                            @include ('result.result.form', ['formMode' => 'edit'])
