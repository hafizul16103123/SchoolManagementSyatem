            ...
            <div class="col-md-9">
                <div class="card bg-info">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('/attendance/' . $attendance->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ method_field('PATCH') }}
                            {{ csrf_field() }}

                            @include ('attendance.attendance.form', ['formMode' => 'edit'])
