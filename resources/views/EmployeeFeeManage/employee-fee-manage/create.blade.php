        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="card bg-info">
                    <div class="card-header">Create New EmployeeFeeManage</div>
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('/employee-fee-manage') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}
