        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="card bg-info">
                    ...
                    <div class="card-body">
                        <a href="{{ url('/room/create') }}" class="btn btn-primary btn-sm" title="Add New Room">
                            ...
                            <table class="table">
                                ...
                                @foreach($room as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->name }}</td>
                                        <td>
                                            <a href="{{ url('/room/' . $item->id) }}" title="View Room"><button class="btn btn-dark btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
